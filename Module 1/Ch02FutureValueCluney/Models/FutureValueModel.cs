...
namespace Ch02FutureValueCluney.Models
{
    public class FutureValueModel
    {
        [Required(ErrorMessage = "Please enther a monthly investment amount")]
        ...
        public decimal? YearlInterestrate { get; set; }
        ...
        {
            int? months = Years * 12;
            decimal? monthlyInterestRate = YearlInterestrate / 12 / 100;
